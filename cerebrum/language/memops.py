...
def write_memory(data, starting_time, ending_time):
	MEM_FILE_PATH = os.path.expanduser("~/cerebrumData/language/memory/" +  str(datetime.date.today()) + ".mem") # Path for mem file
	TSTP_FILE_PATH = os.path.expanduser("~/cerebrumData/language/memory/" +  str(datetime.date.today()) + ".tstp") # Path for tstp file
...
def read_memory(date_day,starting_time):
	MEM_FILE_PATH = os.path.expanduser("~/cerebrumData/language/memory/" +  date_day + ".mem") # Path for mem file
	memory_list = []
...
def read_timestamps(date_day,from_line=0):
	TSTP_FILE_PATH = os.path.expanduser("~/cerebrumData/language/memory/" +  date_day + ".tstp") # Path for tstp file
	timestamp_list = []
