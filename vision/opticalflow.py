def motion_detection(cap,TRACKER_POINTS,CRAZY_LINE_DISTANCE,CRAZY_LINE_LIMIT,ABSDIFF_ANGLE,LINE_THICKNESS,CONTOUR_LIMIT,TARGET_HEIGHT,DELTA_LIMIT_DIVISOR):
