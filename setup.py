...
setup(
	...
	description='Crossmodal Supervised Learning Toolkit with Time Series Memory Recording & Long Short-Term Memory Networks',
	...
	install_requires=['imutils','pyqtgraph','pysrt'],
